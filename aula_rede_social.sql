...
--
-- Estrutura da tabela `listperguntas`
--

CREATE TABLE IF NOT EXISTS `listperguntas` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) DEFAULT NULL,
  `nomecompleto` varchar(255) DEFAULT NULL,
  `emaildousuario` varchar(255) DEFAULT NULL,
  `sexo` varchar(100) DEFAULT NULL,
  `emaildecontato` varchar(255) DEFAULT NULL,
  `mensagem` text,
  `datapergunta` text,
  `dataresposta` text,
  `responder` text,
...
--
-- Estrutura da tabela `listreclamacoes`
--

CREATE TABLE IF NOT EXISTS `listreclamacoes` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) DEFAULT NULL,
  `nomecompleto` varchar(255) DEFAULT NULL,
  `emaildousuario` varchar(255) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `usuarios` (
  ...
  `relacionamento` varchar(64) DEFAULT NULL,
  `colegio` varchar(30) DEFAULT NULL,
  `faculdade` varchar(30) DEFAULT NULL,
  `emailform` varchar(64) DEFAULT NULL,
  `selo` varchar(128) DEFAULT NULL,
  `selodesc` varchar(64) DEFAULT NULL,
  `likes` int(50) DEFAULT NULL,
  `unlikes` int(50) DEFAULT NULL,
  `likou` varchar(255) DEFAULT NULL,
