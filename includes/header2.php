...
{ 
?>
    <table id="foxpiu" border="0">
    <tr><td id="foxpiu0">Nova mensagem</td><td id="foxpiu0c"><a href="#" onclick="document.getElementById('tuf').style.display='none';"><span id="fecha1">X</span></a></td></tr>
    <tr><td id="foxpiu1">Para: <a style="color:#03F;" href="perfil.php?uid=<?php echo $user_id ?>"><?php echo $user_fullname ?></a></td><td id="foxpiu1c"></td></tr>
    <tr><td>
    <form id="cdt" method="post" action="includes/enviarmensagem.php" />
    <input type="hidden" name="de" value="<?php echo $idDaSessao ?>" />
    <input type="hidden" name="para" value="<?php echo $idExtrangeiro ?>" />
    <input type="hidden" name="status" value="1" />
    <input type="hidden" name="data" value="<?php echo date('Y-m-d H:i:s') ?>" />
    <textarea placeholder="Escreva uma mensagem..." name="mensagemp" id="mensagemp"></textarea>
    <td><div id="maexp"><input type="image" src="../images/enviar.png" /></div></td>
    </td></tr>
    </table>
    <?php } ?>
    </span>
...
<div class="cAlign">
    ...
    <div id="content">
		...
		<div class="left">
        	 ...
        	 <!--kp-->
               <div id="foto-capa">
               <?php if(isset($user_capa)){ ?>
               <a href="#"><img src="uploads/capas/id_<?php echo $idExtrangeiro ?>.jpg" alt="<?php echo $user_nome ?>" title="<?php echo $user_nome ?>" /></a>
               <?php }else{echo '<img src="uploads/capas/default.jpg" alt="adicione uma capa" title="adicione uma capa" />';} ?>
                <?php if($idDaSessao==$idExtrangeiro): ?>
                <a href="perfil.php?perfil=UPLOADS" id="alterar-capa">alterar capa</a>
                <?php endif; ?>
                </div>
                <!--endkp-->
                
                
            <div class="blocos" id="foto-perfil2">
            	<a href="#"><img src="uploads/usuarios/<?php echo $user_imagem; ?>" alt="<?php echo $user_nome ?>" title="<?php echo $user_nome ?>" /></a>
                <?php if($idDaSessao==$idExtrangeiro): ?>
                <a href="perfil.php?perfil=UPLOAD" id="alterar-foto2">alterar foto</a>
                <?php endif; ?>
            </div><!--blocos-->
