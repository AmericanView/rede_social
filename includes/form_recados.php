<div id="dexar-recados">
    ...
    <?php $txt_for_recado = ($idDaSessao<>$idExtrangeiro) ? 'Deixe uma mensagem para '.$user_fullname : 'Deixe mensagens para seus amigos' ; 
	...
	if(isset($_POST['postarrecado'])){
		...
		if($_POST['txtrecado']<>''){
			...
			$location = ($idExtrangeiro<>$idDaSessao) ? 'recados.php?uid='.$idExtrangeiro : 'mensagens.php';
    ...
    <div id="contentformrecado">
    	<form name="dexar-recado" action="" method="post" enctype="multipart/form-data">
            ...
            <span style="font-size:13px; font-family:Arial; font-weight:bold;">Enviar para: </span>
        	<select id="recadopara" name="recadopara">
            	<option>Vazio</option>
                <option value="selecionar">Selecionar Amigos</option>
            </select>
            <?php endif; ?>
