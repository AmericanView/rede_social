...
{ 
?>
<form method="post" action="postareclamacoes.php">
...
<input type="hidden" name="datareclamacao" value="<?php echo ''.date('d/m/Y').' as '.date('H:i:s').'' ?>" />
<label>Email para contato:</label><br /><input placeholder="Seu e-mail" type="text" name="emaildecontato" /><br /><br />
<label>Explique o que está lhe incomodando:</label><br /><textarea placeholder="Digite aqui sua reclamação..." name="mensagem" rows="10" cols="50"></textarea><br /><br />
